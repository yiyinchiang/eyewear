...
const GenerationCommonConfigSchema = z.object({
  ...
  maxOutputTokens: z.number().describe("The maximum number of tokens to include in the response.").optional(),
  topK: z.number().describe("The maximum number of tokens to consider when sampling.").optional(),
  topP: z.number().describe(
    "Decides how many possible words to consider. A higher value means that the model looks at more possible words, even the less likely ones, which makes the generated text more diverse."
  ).optional(),
