...
const OpenAIConfigSchema = GenerationCommonConfigSchema.extend({
  ...
  frequencyPenalty: z.number().min(-2).max(2).describe(
  ...
  logProbs: z.boolean().describe(
    "Whether to return log probabilities of the output tokens or not."
  ).optional(),
  presencePenalty: z.number().min(-2).max(2).describe(
  ...
  topLogProbs: z.number().int().min(0).max(20).describe(
